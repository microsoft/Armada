...
//      if (ch == EOL) { line++; col = 0; }
  ...
  public void CheckLiteral() {
		switch (t.val) {
			...
			case "commit": t.kind = 91; break;
			case "include": t.kind = 92; break;
			case "abstract": t.kind = 93; break;
			case "noaddr": t.kind = 94; break;
			case "layer": t.kind = 95; break;
			case "level": t.kind = 96; break;
			case "structs": t.kind = 97; break;
			case "proof": t.kind = 98; break;
			case "using": t.kind = 99; break;
			case "refines": t.kind = 100; break;
			case "opened": t.kind = 101; break;
			case "provides": t.kind = 103; break;
			case "reveals": t.kind = 104; break;
			case "extends": t.kind = 105; break;
			case "struct": t.kind = 106; break;
			case "yield_predicate": t.kind = 107; break;
			case "refinement": t.kind = 108; break;
			case "include_file": t.kind = 109; break;
			case "which_includes": t.kind = 110; break;
			case "import_module": t.kind = 111; break;
			case "which_imports": t.kind = 112; break;
			case "extra": t.kind = 113; break;
			case "inductive_invariant": t.kind = 114; break;
			case "depends_on": t.kind = 115; break;
			case "use_regions": t.kind = 116; break;
			case "use_address_invariant": t.kind = 117; break;
			case "chl_invariant": t.kind = 118; break;
			case "chl_yield_pred": t.kind = 119; break;
			case "auxiliary": t.kind = 120; break;
			case "weakening": t.kind = 121; break;
			case "starweakening": t.kind = 122; break;
			case "statements": t.kind = 123; break;
			case "variables": t.kind = 124; break;
			case "var_hiding": t.kind = 125; break;
			case "stack_var_hiding": t.kind = 126; break;
			case "var_intro": t.kind = 127; break;
			case "stack_var_intro": t.kind = 128; break;
			case "reduction": t.kind = 129; break;
			case "phase1": t.kind = 130; break;
			case "phase2": t.kind = 132; break;
			case "combining": t.kind = 133; break;
			case "field_hiding": t.kind = 134; break;
			case "field_intro": t.kind = 135; break;
			case "assume_intro": t.kind = 136; break;
			case "chl": t.kind = 137; break;
			case "critsec": t.kind = 138; break;
			case "tso_elim": t.kind = 139; break;
			case "refinement_constraint": t.kind = 140; break;
			case "new": t.kind = 141; break;
			case "yields": t.kind = 142; break;
			case "returns": t.kind = 143; break;
			case "comethod": t.kind = 146; break;
			case "destructor": t.kind = 147; break;
			case "free": t.kind = 148; break;
			case "awaits": t.kind = 149; break;
			case "yield": t.kind = 150; break;
			case "ptr": t.kind = 151; break;
			case "explicit_yield": t.kind = 155; break;
			case "atomic": t.kind = 156; break;
			case "label": t.kind = 157; break;
			case "break": t.kind = 158; break;
			case "continue": t.kind = 159; break;
			case "where": t.kind = 160; break;
			case "return": t.kind = 161; break;
			case "join": t.kind = 162; break;
			case "create_thread": t.kind = 165; break;
			case "malloc": t.kind = 166; break;
			case "calloc": t.kind = 167; break;
			case "if": t.kind = 168; break;
			case "while": t.kind = 169; break;
			case "match": t.kind = 170; break;
			case "assert": t.kind = 171; break;
			case "wait_until": t.kind = 172; break;
			case "print": t.kind = 173; break;
			case "somehow": t.kind = 174; break;
			case "dealloc": t.kind = 175; break;
			case "forall": t.kind = 176; break;
			case "parallel": t.kind = 177; break;
			case "modify": t.kind = 178; break;
			case "exists": t.kind = 196; break;
			case "false": t.kind = 202; break;
			case "true": t.kind = 203; break;
			case "null": t.kind = 204; break;
			case "this": t.kind = 205; break;
			case "fresh": t.kind = 208; break;
			case "allocated": t.kind = 209; break;
			case "allocated_array": t.kind = 210; break;
			case "unchanged": t.kind = 211; break;
			case "old": t.kind = 213; break;
			default: break;
		}
  }
      ...
      case 0: {
        ...
        t.kind = recKind; break;
			...
			case 107:
				{t.kind = 206; break;}
			case 108:
				if (ch == 'b') {AddCh(); goto case 109;}
				else {goto case 0;}
			case 109:
				if (ch == '_') {AddCh(); goto case 110;}
				else {goto case 0;}
			case 110:
				if (ch == 'e') {AddCh(); goto case 111;}
				else {goto case 0;}
			case 111:
				if (ch == 'm') {AddCh(); goto case 112;}
				else {goto case 0;}
			case 112:
				if (ch == 'p') {AddCh(); goto case 113;}
				else {goto case 0;}
			case 113:
				if (ch == 't') {AddCh(); goto case 114;}
				else {goto case 0;}
			case 114:
				if (ch == 'y') {AddCh(); goto case 115;}
				else {goto case 0;}
			case 115:
				{t.kind = 207; break;}
			case 116:
				recEnd = pos; recKind = 212;
				if (ch == '"') {AddCh(); goto case 32;}
				else {t.kind = 212; break;}
			case 117:
			...
			case 120:
				...
				else if (ch == '=') {AddCh(); goto case 129;}
			...
			case 125:
				recEnd = pos; recKind = 200;
				if (ch == '&') {AddCh(); goto case 96;}
				else {t.kind = 200; break;}
			case 126:
				if (ch == 'm') {AddCh(); goto case 106;}
			...
			case 128:
				recEnd = pos; recKind = 214;
				if (ch == '.') {AddCh(); goto case 53;}
				else {t.kind = 214; break;}
			case 129:
			...
			case 130:
				...
				if (ch == '=') {AddCh(); goto case 131;}
				else {t.kind = 180; break;}
			case 131:
				recEnd = pos; recKind = 188;
				if (ch == '>') {AddCh(); goto case 91;}
				else {t.kind = 188; break;}
